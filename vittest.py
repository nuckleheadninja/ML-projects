...
# ------------------------------
NUM_CLASSES = 41
MODEL_PATH = r"D:\Python basics\AI project\basics.py\best_vit_model.pth"  # Your ViT-Small checkpoint
...
# Load Test Dataset
# ------------------------------
testdataset_path = r"C:\Users\User\indian_bovine_split_cropped\test"
...
plt.xlabel("Breed")
plt.ylabel("Score")
plt.title("Precision, Recall, F1 per Class - Test Set")
plt.legend()
plt.tight_layout()
plt.show()
